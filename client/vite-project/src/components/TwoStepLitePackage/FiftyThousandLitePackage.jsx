...
const FiftyThousandLitePackage = () => {
    ...
    <div>
       <div className="oneStep p-3">
                <h2 className='text-white text-start mainValue-text'>$50,000</h2>
                    ...
                    <div>
                        <p className='profit-value-text text-start'>$167 <span className='text-dark fs-5'><s>$222</s></span></p>
                    </div>
...
export default FiftyThousandLitePackage
